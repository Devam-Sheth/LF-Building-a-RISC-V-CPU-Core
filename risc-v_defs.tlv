...
\TLV riscv_gen()
   ...
   \SV_plus
      ...
      // MODIFIED: Changed type of CUSTOM_0 from '_' to 'R' to support CUSTOM_RSQR as R-type
      m4_op5(00010, R, CUSTOM_0) 
   ...
   \SV_plus
      ...
      //       |  |   |  |      func3,   // (if applicable)
      //       |  |   |  |      |    mnemonic)
      // --- Standard Base Instructions (RV32I / RV64I) ---
      m4_instr(U, 32, I, 01101,      LUI)
      ...
      m4_instr(If, 32, I, 00100, 001, 000000, SLLI)  // funct7[6:1] is 000000 for SLLI
      m4_instr(If, 32, I, 00100, 101, 000000, SRLI)  // funct7[6:1] is 000000 for SRLI
      m4_instr(If, 32, I, 00100, 101, 010000, SRAI)  // funct7[6:1] is 010000 for SRAI
      m4_instr(R, 32, I, 01100, 000, 0000000, ADD)
      ...
      // op5 is 00010.
      m4_instr(R, 32, I, 00010, 001, 0000010, CUSTOM_RSQR)
      ...
      // ... (and other RV64I specific variants like SLLIW, ADDW etc.)

      // --- Other Extensions (F, D, Q, A, B) ---
      // ... (These are extensive and kept as in your original file) ...
      // ... (ensure M4_EXT_F, M4_EXT_D etc. are set if you use them) ...
      ...
      // ... (rest of F, D, Q, A, B extensions from your original file)
      ...
      // ... and so on for other B extension instructions
      m4_instr(R2, 32, B, 01100, 001, 0110000, 00000, CLZ)
      ...
      // ... (ensure all other instructions from original file are preserved)
